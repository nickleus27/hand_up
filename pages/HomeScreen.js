        ...
        function (tx, res) {
          ...
          if (res.rows.length == 0) {
            ...
            txn.executeSql(
              ...
              'CREATE TABLE IF NOT EXISTS soup_kitchen_table(row_id INTEGER PRIMARY KEY AUTOINCREMENT, org_name VARCHAR(20), week_day VARCHAR(10), hour VARCHAR(10), address VARCHAR(255), phone VARCHAR(12), email VARCHAR(255), website VARCHAR(255), isSelect VARCHAR(5), notif INT)',
              [],
            );
          }
        },
